  ...
  return (
    <div className="min-h-screen bg-white px-5 py-25 text-black">
      ...
      <header className="max-w-[1200px] mx-auto mb-16">
        ...
        <div className="flex items-center gap-2 text-zinc-400  tracking-widest text-xs uppercase">
      ...
      <main className="max-w-[1200px] mx-auto space-y-12">
        ...
        <section>
          <h2 className="text-xl  title-font mb-4 flex items-center gap-3">
        ...
        <section className="p-8 rounded-3xl bg-zinc-50 border border-zinc-100">
          <h2 className="text-xl  title-font mb-4 flex items-center gap-3 text-black">
          ...
          <div className="space-y-4 text-zinc-600 title-font2 text-sm">
            ...
            <div className="mt-4 p-4 bg-red-50 text-red-600 rounded-xl  text-xs flex items-start gap-2">
          ...
          <div className="space-y-4 text-zinc-600 title-font2">
            ...
            <div className="flex flex-wrap gap-4">
              <div className="flex-1 min-w-[200px] border border-zinc-200 p-4 rounded-2xl">
                <span className="block text-[10px] text-zinc-400 uppercase">Service Fee</span>
                <span className="text-2xl">20%</span>
              </div>
              <div className="flex-1 min-w-[200px] border border-zinc-200 p-4 rounded-2xl">
                <span className="block text-[10px] text-zinc-400 uppercase">Min. Withdrawal</span>
        ...
        <section>
          ...
          <div className="p-6 border-l-4 border-black bg-zinc-50 rounded-r-2xl">
            <p className="text-lg  title-font">₦500 per hour</p>
        ...
        <footer className="bg-black text-white p-10 rounded-[40px] mb-10">
          ...
          <div className="grid md:grid-cols-2 gap-6 title-font2">
            <div>
              <p className="">Bingham University</p>
              <p className="text-zinc-400">Karu, Nasarawa State, Nigeria</p>
            </div>
            <div>
              <p className="">09043647942</p>
              <p className="">08101892870</p>
            </div>
          </div>
        </footer>
      </main>
